      ...
      <div className="px-6 py-5 space-y-4">
        ...
        {profile.is_system_admin && (
          <button
            ...
            className="w-full py-3 bg-[#13261d] text-whatsapp-green border border-whatsapp-green/30 rounded-xl font-semibold hover:bg-whatsapp-green/10 transition-colors flex items-center justify-center gap-2"
          >
